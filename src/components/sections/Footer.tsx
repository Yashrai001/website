      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="text-muted-foreground leading-relaxed pr-4 mb-8">
              Luxury spaces for life&apos;s most beautiful celebrations. Creating unforgettable memories in elegant surroundings.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/halls" className="text-muted-foreground hover:text-primary transition-colors">Venues & Halls</Link></li>
              <li><Link href="/weddings" className="text-muted-foreground hover:text-primary transition-colors">Weddings</Link></li>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-serif text-lg font-medium mb-6 text-foreground">Contact Us</h4>
            <ul className="space-y-4">
              <li>
                <a 
          ...
          {/* Opening Hours */}
          <div>
            <h4 className="font-serif text-lg font-medium mb-6 text-foreground">Availability</h4>
